...
export const usePokemonPaginate = () => {
  ...
  const loadPokemons = async () => {
    ...
    setNextPageUrl(res.data.next); // Corregido el nombre de la propiedad "next"
    mapPokemos(res.data.results);
  };
  ...
  const mapPokemos = async (pokemons) => {
    ...
    for await (const pokemon of pokemons) {
      ...
      newPokemonList.push({
        ...
        color: POKEMON_TYPE_COLORS[pokemonDetail.types[0].type.name.toLowerCase()],
      });
    }
